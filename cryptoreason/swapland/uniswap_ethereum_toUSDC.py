...
# Token addresses
QUOTE_TOKEN_ADDRESS="0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2"  # WETH
BASE_TOKEN_ADDRESS="0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48"  # USDC


# Connect to RPC node (Ethereum chain)
web3 = create_multi_provider_web3(os.environ.get("YOUR_INFURA_PROJECT_ID"))
