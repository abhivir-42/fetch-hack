...
This script swaps USDC for WETH on Uniswap v3 (Polygon network).
...
- Get MATIC for gas and USDC for the trade (use native USDC).
...
# Token addresses
QUOTE_TOKEN_ADDRESS = "0x7ceb23fd6bc0add59e62ac25578270cff1b9f619"  # WETH
BASE_TOKEN_ADDRESS =  "0x3c499c542cef5e3811e1192ce70d8cc03d5c3359"  # USDC (native)
...
# Fetch Uniswap v3 contract for Polygon
